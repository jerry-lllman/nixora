      ...
      <div className="mx-auto flex min-h-screen w-full max-w-6xl flex-col px-6 py-10 md:px-12 md:py-16">
        <header className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-xs font-medium uppercase tracking-[0.35em] text-emerald-400">
                Studio
              </p>
          ...
          <section className="space-y-6">
            <div className="space-y-4">
              ...
              <p className="max-w-xl text-lg text-slate-300">
                Nixora Studio combines a visual builder, content operations, and deployment
                automation so your team can go from concept to live experience without context
                switching.
              </p>
            </div>
        ...
        <section className="mt-24 grid gap-6 md:grid-cols-3">
          <article className="flex flex-col gap-3 rounded-2xl border border-slate-800 bg-slate-900/70 p-6 shadow-xl shadow-emerald-500/5">
            ...
            <p className="text-sm text-slate-300">
              Drag-and-drop modules, connect APIs, and preview responsive layouts before they hit
              production.
            </p>
          </article>
          <article className="flex flex-col gap-3 rounded-2xl border border-slate-800 bg-slate-900/70 p-6 shadow-xl shadow-emerald-500/5">
            ...
            <p className="text-sm text-slate-300">
              Manage copy reviews, creative approvals, and deployment windows with native tasks
              and automations.
            </p>
          </article>
          <article className="flex flex-col gap-3 rounded-2xl border border-slate-800 bg-slate-900/70 p-6 shadow-xl shadow-emerald-500/5">
            ...
            <p className="text-sm text-slate-300">
              Single sign-on, audit trails, and compliance exports keep your governance teams
              confident.
            </p>
          </article>
        </section>
